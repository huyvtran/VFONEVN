...
#include "../../include/pjsip/sip_private.h"
#include "../../include/pjsip/sip_errno.h"
#include "../../include/pjsip/sip_module.h"

#include "../../../pjlib/include/pj/addr_resolv.h"
...
#include "../../../pjlib/include/pj/hash.h"
...
//  Khai Le
char* stringReplaceWord(char *source, char *oldW, char *newW)
//  -----
...
char* stringReplaceWord(char *source, char *oldW, char *newW) {
    ...
    for (i = 0; source[i] != '\0'; i++) {
        if (strstr(&source[i], oldW) == &source[i]) {
            cnt++;
...
//                char *rs = stringReplaceWord(package, substr, empty);
//                strcpy(package, rs);
...
//                strcpy(package, rs);
//                strcpy(rdata->pkt_info.packet, package);
//                PJ_LOG(4,(THIS_FILE, "package = %s", package));
//                break;
//            }
//        }
//    }
...
//    if (result != NULL) {
////        char substr[1000] = "";
////        char *empty = "m=audio 13768 RTP/AVP 8 0 101\n\r";
////        for (int i=0; i<strlen(result); i++) {
////            char c = result[i];
////            if (c == '\n') {
////                strncpy(substr, result, i+1);
...
//    }
	...
	pj_size_t msg_fragment_size;
        ...
        PJ_LOG(4,(THIS_FILE, "current_pkt = %s", current_pkt));
